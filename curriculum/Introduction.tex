...
This document is the official curriculum reference for the Department of
Mathematics at The University of Texas at San Antonio (UTSA). It serves two
complementary purposes: it catalogues the mathematics courses offered by
the department together with their learning objectives and assessment
strategies, and it provides the technical infrastructure guide needed to
contribute to, maintain, and extend the curriculum repository. Vertical
alignment (the progression of concepts across successive courses) and
horizontal alignment (the coordination of content within a common tier)
are the central concerns of the document.

\noindent
You can retrieve the current edition from the department repository at:\\
\url{\ProjectGit}. \\
