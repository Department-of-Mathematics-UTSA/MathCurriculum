...
\ProjectName{} project. It covers the software environment, programming
foundations, and data challenge materials needed to perform tasks 
related to the project. It is \emph{not} intended to be read cover to cover.
...
You can retrieve the current edition from the program repository at:\\
\url{\ProjectGit}. \\
